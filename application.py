...
#        self.modeltype = "sql"
        ...
        stmtW  = 50; stmtH = 6
        #self.statmt = scrolledtext.ScrolledText(stmtFrame, width=quoteW, height=quoteH, wrap=tk.WORD)
        ...
        recFrame = ttk.LabelFrame(self.mySQL, text=' Table Records: ')
        recFrame.grid(row=2, padx=4, pady=4, sticky='WE')
        
        
        
        self.datalist = v.DbRecList(recFrame, self.callbacks)
        self.updateDatalist()
